...
/**
 * Clase Articulo, que implementa Serializable, para representar un objeto con
...
public class Articulo implements Serializable {
    ...
    public static int getCodigoUltimoElemento() {
        return Articulo.codigoUltimoArticulo ;
    }
     ...
     */
    protected static void setCodigoUltimoArticulo(int codigoUltimoArticulo) throws IllegalArgumentException {
        if (codigoUltimoArticulo >= 0) {
            Articulo.codigoUltimoArticulo = codigoUltimoArticulo ;
        } else {
    ...
    private void setCodigoArticulo() {
        ...
        this.codigo = ++Articulo.codigoUltimoArticulo ;
    }
     ...
     */
    public Articulo(String descripcion, int annio, String pais, 
